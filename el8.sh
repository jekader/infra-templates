...
yum -y install java-11-openjdk-headless git mock python3-pyyaml python3-pyxdg python3-six
...
chown -R jenkins-staging:jenkins-staging /home/jenkins/.ssh/authorized_keys
